...
(function (la, s, p) {
	(function (i) {
		...
		var l = function (h) {
			...
			var ga = /\[.*?\]$/,
			kb = la.JSON ? JSON.stringify : function (a) {
				var b = typeof a;
				if (b !== "object" || a === null) {
					if (b === "string")
						a = '"' + a + '"';
			...
			full_numbers: {
				...
				fnUpdate: function (h, n) {
					if (h.aanFeatures.p) {
						...
						w = Math.ceil(h._iDisplayStart / h._iDisplayLength) + 1,
						D = "",
						A,
						G = h.oClasses,
						E,
